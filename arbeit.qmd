...
While **Model 3** was not initially intended as a mere robustness check, its lack of significant results changes its interpretive role. Rather than uncovering additional explanatory dimensions, it reinforces the findings of Models 1 and 2: persistent abstention in Switzerland appears to be driven primarily by political motivation and structural inequalities. The absence of effects for media use and social networks suggests that political disengagement is less about communication over environments or embedded, and more about deeper attitudinal and resource-based barriers. 
