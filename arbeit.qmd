...
coef_map <- c(
  ...
  "edu_grouphigh"     = "Tertiary education",
  "income_cathigh"    = "High income",
  "job_catparttime"   = "Part-time employment",
  "job_catother"      = "Other employment"
)

tbl <- modelsummary(
  list("Model 1" = m1, "Model 2" = m2),
  shape    = term ~ model + response,   # 6 Outcome-Spalten
  coef_map = coef_map,
  estimate = "{estimate}{stars}",
  statistic= "({std.error})",
  fmt      = 2,
  gof_omit = "IC|Deviance",
  output   = "kableExtra" 
)

tbl |>
  add_header_above(c(" " = 1,
                     "Model 1 (Motivation)" = 3,
                     "Model 2 (+ Resources)" = 3)) |>
